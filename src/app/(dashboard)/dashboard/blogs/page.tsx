...
export default function BlogsPage() {
  ...
  const [editingBlog, setEditingBlog] = useState<Partial<Post> | null>(null)
  ...
  // ✅ Handle Create
  const handleCreate = (blog: Partial<Post>) => {
    const newBlog: Post = {
      ...blog,
      id: Date.now(),
      ...
      slug:
        blog.slug ??
        (blog.title ? blog.title.toLowerCase().replace(/\s+/g, "-") : "untitled"),
  ...
  // ✅ Handle Update
  const handleUpdate = (updatedData: Partial<Post>) => {
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage your blog content dynamically
          </p>
        </div>
